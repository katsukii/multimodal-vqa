...
figure.) A continuation to 8 epochs (validation was still rising at 5) reached val 0.5705 and
**test 0.58955** with a lower majority-class share, but finished just after the submission
deadline, so 0.57843 remained the graded result. A CLIP vision encoder (row 4), despite being
vision-language aligned,

...
- **Held-out val 0.5705** (best at epoch 7); **test 0.58955** (measured after the deadline).
  Qualitatively the best run: unanswerable share 0.694 (vs 0.73–0.74 earlier) and 182 unique
  answers (vs ~89), i.e. least majority-class collapse. It finished just after the submission
  window closed, so 0.57843 remained the graded submission.
- Files here:
...
| vit_bert_plain_long (8 ep) — not submitted | **0.5705** | 0.58955 (post-deadline) |
